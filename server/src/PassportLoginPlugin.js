/* This is a PostGraphile plugin
 * It runs server-side to provide an API for authentication
 * The Authentication API is available through GQL using the typeDefs defined below
 * The API is implemented using a postgresl client and SQL statements
 * See: 
 */
